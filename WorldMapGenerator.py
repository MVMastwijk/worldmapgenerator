#Tkinter GUI version: Win10
#Author: MV Mastwijk

#Tutorial:

#1 Under the "Seed:" tab either input a seed or click "Random Seed".

#2 Click "Generate" to generate the required maps. 
#Depending on hardware this should take ~5-20 sec.

#3 Use the "Display:" tab to display the various maps.

#4 Clicking on a tile in the map shows relevant 
#info under the "Tile Info:" tab.
...
input1=Entry(window, bg="white", fg="black", font="none 12", width=14)
input1.insert(1,random.randint(100000000000,999999999999))
input1_disp=disp.create_window(713, 60, anchor=NW, window=input1)

text1=Label(window, text="Seed:", bg="gray20", fg="white", font="none 12 bold", width=6)
text1_disp=disp.create_window(623, 60, anchor=NW, window=text1)

text2=Label(window, text="Display:", bg="gray20", fg="white", font="none 12 bold", width=6)
text2_disp=disp.create_window(623, 130, anchor=NW, window=text2)

text3=Label(window, text="Tile Info:", bg="gray20", fg="white", font="none 12 bold", width=8)
text3_disp=disp.create_window(723, 130, anchor=NW, window=text3)

text4=Label(window, text="x:", bg="gray20", fg="white", font="none 10", width=1)
text4_disp=disp.create_window(723, 165, anchor=NW, window=text4)

text5=Label(window, text="-", bg="gray20", fg="white", font="none 10", width=3)
text5_disp=disp.create_window(737, 165, anchor=NW, window=text5)

text6=Label(window, text="y:", bg="gray20", fg="white", font="none 10", width=1)
text6_disp=disp.create_window(773, 165, anchor=NW, window=text6)

text7=Label(window, text="-", bg="gray20", fg="white", font="none 10", width=3)
text7_disp=disp.create_window(787, 165, anchor=NW, window=text7)

text8=Label(window, text="-", bg="gray20", fg="white", font="none 8", width=22)
text8_disp=disp.create_window(723, 195, anchor=NW, window=text8)

text9=Label(window, text="Height:", bg="gray20", fg="white", font="none 8", width=8)
text9_disp=disp.create_window(723, 216, anchor=NW, window=text9)

text10=Label(window, text="-", bg="gray20", fg="white", font="none 8", width=2)
text10_disp=disp.create_window(771, 216, anchor=NW, window=text10)

text11=Label(window, text="Heat:", bg="gray20", fg="white", font="none 8", width=8)
text11_disp=disp.create_window(723, 237, anchor=NW, window=text11)

text12=Label(window, text="-", bg="gray20", fg="white", font="none 8", width=2)
text12_disp=disp.create_window(771, 237, anchor=NW, window=text12)

text13=Label(window, text="Humidity:", bg="gray20", fg="white", font="none 8", width=8)
text13_disp=disp.create_window(723, 258, anchor=NW, window=text13)

text14=Label(window, text="-", bg="gray20", fg="white", font="none 8", width=2)
text14_disp=disp.create_window(771, 258, anchor=NW, window=text14)


button1=Button(window, text="Generate", font="none 10", width=10, command=generateworldmap)
button1_disp=disp.create_window(623, 95, anchor=NW, window=button1)

button2=Button(window, text="Random Seed", font="none 10", width=10, command=randomseed)
button2_disp=disp.create_window(723, 95, anchor=NW, window=button2)

button3=Button(window, text="Landscape", font="none 8", width=10, command=lambda:displaytype(1,xsize,ysize))
button3_disp=disp.create_window(623, 165, anchor=NW, window=button3)
button4=Button(window, text="Height", font="none 8", width=10, command=lambda:displaytype(2,xsize,ysize))
button4_disp=disp.create_window(623, 190, anchor=NW, window=button4)
button5=Button(window, text="Heat", font="none 8", width=10, command=lambda:displaytype(3,xsize,ysize))
button5_disp=disp.create_window(623, 215, anchor=NW, window=button5)
button6=Button(window, text="Humidity", font="none 8", width=10, command=lambda:displaytype(4,xsize,ysize))
button6_disp=disp.create_window(623, 240, anchor=NW, window=button6)
button7=Button(window, text="Nothing", font="none 8", width=10, command=lambda:displaytype(0,xsize,ysize))
